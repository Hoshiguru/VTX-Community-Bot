                    ...
                    Commands.slash("frames", "show frame data for a character")
                            .addOptions(
                                    ...
                                    new OptionData(OptionType.STRING, "move",
                                            "example: df1+2", true)),
                    Commands.slash("tournaments", "show tournament information")
                            .addOptions(
                                    new OptionData(OptionType.STRING, "game",
                                            "Choose a game", true)
                                            .addChoice("TEKKEN 8", "TEKKEN 8")
                                            .addChoice("Street Fighter 6", "Street Fighter 6")
                                            .addChoice("Guilty Gear Strive", "Guilty Gear Strive")
                                            .addChoice("Super Smash Bros. Ultimate", "Super Smash Bros. Ultimate"),
                                    new OptionData(OptionType.STRING, "location",
                                            "Choose a location", true)
                                            .addChoice("Switzerland", "CH")
                                            .addChoice("Germany", "DE")
                                            .addChoice("France", "FR")
                                            .addChoice("USA", "US")
                                            .addChoice("Japan", "JP")
                                            .addChoice("Korea", "KR")
